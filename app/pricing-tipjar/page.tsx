...
export const metadata: Metadata = {
  title: 'Pricing - TipJar.Live',
  description: 'Simple, fair pricing for DJs. Start free, upgrade when you\'re making money. All plans include 3.5% + $0.30 platform fee only when you get paid.',
};
      ...
      <section className="bg-tipjar-gradient dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-950 py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-gray-300 max-w-2xl mx-auto">
            Start free, upgrade when you&apos;re making money. No credit card required.
          </p>
        </div>
      </section>
