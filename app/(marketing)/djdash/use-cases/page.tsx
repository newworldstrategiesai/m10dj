...
export const metadata: Metadata = {
  title: 'Use Cases | DJ Dash - For Every Type of DJ Business',
  description: 'See how DJ Dash works for solo DJs, growing companies, and scaling businesses. Real case studies and success stories.',
  keywords: [
    'DJ business software use cases',
    'DJ CRM use cases',
    'DJ booking software examples',
    'DJ management software case studies'
  ],
};
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900">
            ...
            {useCases.map((useCase, idx) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Visual */}
                  <div className={`bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-gray-800 dark:to-gray-700 rounded-xl p-8 h-96 flex items-center justify-center ${idx % 2 === 1 ? 'md:order-1' : ''}`}>
                    <div className="text-center">
                      <div className="w-24 h-24 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl flex items-center justify-center shadow-lg">
                        <IconComponent className="w-12 h-12 text-white" />
                      </div>
                      <p className="text-sm text-gray-600 dark:text-gray-400 font-medium">Dashboard Preview</p>
                    </div>
                  </div>
                </div>
              );
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-xl p-8 md:p-12 border border-gray-200 dark:border-gray-700 shadow-lg">
            <div className="mb-8">
            ...
            <div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                {caseStudy.results.map((result, idx) => (
                  <div
                    key={idx}
                    className="bg-gradient-to-br from-gray-50 to-blue-50 dark:from-gray-800 dark:to-gray-700 rounded-lg p-6 border border-gray-200 dark:border-gray-600"
                  >
                    <div className="text-sm text-gray-500 dark:text-gray-400 mb-3 uppercase tracking-wider font-semibold">
                      {result.metric}
                    </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 to-cyan-600 text-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/djdash/signup"
            className="inline-flex items-center bg-green-500 hover:bg-green-600 text-white px-8 py-4 rounded-lg font-semibold text-lg uppercase tracking-wider transition-colors shadow-lg hover:shadow-xl"
          >
