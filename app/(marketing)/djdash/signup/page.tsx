...
export const metadata: Metadata = {
  title: 'Sign Up | DJ Dash - Start Your Free Trial',
  description: 'Start your free 14-day trial. No credit card required. Get instant access to the complete DJ business management platform.',
};
  ...
  const benefits = [
    {
      ...
      description: 'Get immediate access to your dashboard after signup',
    },
    {
      icon: FileText,
      title: 'Import Data in Minutes',
      description: 'Import contacts, events, and data from spreadsheets or CSV files',
    },
    {
      icon: BarChart3,
      title: 'Full Feature Access',
      description: 'Try all features during your 14-day free trial',
    },
    {
      icon: Music,
      title: 'No Credit Card Required',
      description: 'Start your trial without entering payment information',
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-8">
                Instant Access to Dashboard—Import Data in Minutes
              </h2>
      ...
      <section className="py-12 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-gray-600 dark:text-gray-400 mb-4">
            Trusted by 1,200+ pro DJs • $4.5M+ revenue managed
          </p>
          <div className="flex items-center justify-center space-x-8 opacity-60">
            <div className="text-sm font-semibold text-gray-500 dark:text-gray-400">Powered by Stripe</div>
            <div className="text-sm font-semibold text-gray-500 dark:text-gray-400">SOC 2 Compliant</div>
            <div className="text-sm font-semibold text-gray-500 dark:text-gray-400">GDPR Ready</div>
          </div>
        </div>
      </section>
