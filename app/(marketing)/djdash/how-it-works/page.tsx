...
export const metadata: Metadata = {
  title: 'DJ Event Planner Software | How DJ Dash Works | Event Management for DJs',
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            DJ Event Planner Software<br />Complete Event Management Workflow
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            See how our DJ event planner software works: from client inquiry to event completion. Streamline your entire DJ business workflow with automated contracts, invoicing, and analytics.
          </p>
