...
export const metadata: Metadata = {
  title: 'Features - TipJar.Live',
  description: 'Everything you need to collect tips and manage song requests. See all features for DJs and event attendees.',
};
      ...
      <section className="bg-tipjar-gradient dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-950 py-20">
        <div className="container mx-auto px-4">
          ...
          <p className="text-xl text-center text-gray-300 max-w-2xl mx-auto">
            Powerful features for DJs. Simple experience for guests.
          </p>
        </div>
      </section>
