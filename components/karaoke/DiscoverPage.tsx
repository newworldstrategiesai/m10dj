  ...
  const playlists: Playlist[] = [
    {
      ...
      subtitle: 'Timeless hits everyone knows',
    ...
    },
    {
      id: '2',
      title: 'BEST OF',
      subtitle: 'All-time greatest karaoke songs',
      imageUrl: '/api/placeholder/320/180',
    ...
    },
    {
      ...
      subtitle: 'Rock anthems from legendary bands',
      imageUrl: '/api/placeholder/320/180',
    ...
    },
    {
      ...
      subtitle: 'Country music favorites',
      imageUrl: '/api/placeholder/320/180',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {playlists.map((playlist) => (
            ...
            >
              ...
              <div className={`aspect-video bg-gradient-to-br ${playlist.gradient} relative`}>
                {/* Premium Lock */}
                ...
                <div className={`absolute inset-0 bg-black/40 flex items-center justify-center transition-opacity duration-300 ${
                  ...
                  <Button
                    ...
                    disabled={playlist.isPremium && !isPremium}
                  >
              ...
              {/* Content */}
              <div className="p-4">
                <h3 className="font-bold text-white text-lg mb-1">{playlist.title}</h3>
                <p className="text-gray-400 text-sm mb-3">{playlist.subtitle}</p>
