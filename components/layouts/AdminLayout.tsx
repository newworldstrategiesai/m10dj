...
export default function AdminLayout({ children, title, description, showPageTitle, pageTitle, pageDescription, newButton }: AdminLayoutProps) {
  ...
  const logoSrc = effectiveProductContext === 'tipjar'
    ...
    : '/assets/admin-icon.svg'; // Generic admin icon
              ...
              <div className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 xl:px-8">
                <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center py-4 sm:py-6 gap-3 sm:gap-0">
                  <div className="flex items-center flex-wrap gap-3">
                    ...
                    {pageTitle && (
                      <>
                        <div className="w-10 h-10 flex items-center justify-center flex-shrink-0 bg-gray-100 dark:bg-gray-700 rounded-lg">
                          {effectiveProductContext === 'tipjar' ? (
                            <img
                              src={mounted ? logoSrc : '/assets/TipJar-Logo-Icon.png'}
                              alt="TipJar Logo"
