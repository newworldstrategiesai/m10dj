      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-gradient-to-b from-gray-50 to-blue-50 dark:from-gray-900 dark:to-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            DJ Invoicing Software Pricing<br />Best DJ Booking Software Plans
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 mb-8">
            Transparent pricing for the best DJ booking software with automated DJ invoicing software. All plans include 14-day free trial. 3.5% + $0.30 fee only on payments (no hidden costs).
          </p>
          
          <AnnualToggle isAnnual={isAnnual} onToggle={setIsAnnual} />
        </div>
      </section>
