...
export default function BasicInfoStep({
  ...
  const effectiveSmsPhone = data.adminSmsPhone ?? userPhone ?? '';
        ...
        <div className="mb-8">
          <div className="flex items-start gap-3">
            <input
              id="smsNotifications"
              type="checkbox"
              checked={Boolean(data.adminSmsOptIn)}
              onChange={(e) =>
                onDataUpdate({
                  adminSmsOptIn: e.target.checked
                })
              }
            ...
            <div>
              ...
              >
                Text me when I get new contact form submissions and leads
              </label>
              <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                We&apos;ll use your phone number below for SMS notifications. You can change this anytime
                in Account settings.
              </p>
              <div className="mt-3">
                ...
                <input
                  type="tel"
                  value={effectiveSmsPhone}
                  onChange={(e) =>
                    onDataUpdate({
                      adminSmsPhone: e.target.value
                    })
                  }
                  placeholder={userPhone ? userPhone : '(555) 123-4567'}
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-900 text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-purple-500 text-sm"
                />
              </div>
            </div>
          </div>
