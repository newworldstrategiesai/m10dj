...
const plans = [
  {
    ...
    name: 'Free Forever',
    price: 0,
    priceId: process.env.NEXT_PUBLIC_TIPJAR_STARTER_PRICE_ID || 'price_starter',
  ...
  },
  {
    ...
    name: 'Pro',
    price: 29,
    priceId: process.env.NEXT_PUBLIC_TIPJAR_PROFESSIONAL_PRICE_ID || 'price_professional',
  ...
  },
  {
    ...
    name: 'Embed Pro',
    price: 49,
    priceId: process.env.NEXT_PUBLIC_TIPJAR_ENTERPRISE_PRICE_ID || 'price_enterprise',
