...
export default function OrganizationKaraokePage() {
  ...
  if (loading) {
    return (
      <>
        ...
        <div className="h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center overflow-auto">
  ...
  return (
    <>
      ...
      <div className="h-screen bg-gradient-to-br from-purple-50 to-blue-50 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center p-4 overflow-auto">
