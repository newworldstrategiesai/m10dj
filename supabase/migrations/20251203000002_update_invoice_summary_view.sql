-- Update invoice_summary view to include organization_id
-- This allows filtering invoices by organization for multi-tenant support
...
-- Recreate view with organization_id included
...
COMMENT ON VIEW public.invoice_summary IS 'Complete invoice overview with contact and payment information, including organization_id for multi-tenant filtering';
