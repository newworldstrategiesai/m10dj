...
COMMENT ON COLUMN notification_log.contact_submission_id IS 'References the contact submission that triggered notifications';
COMMENT ON COLUMN notification_log.notification_type IS 'Type of notification (lead_alert, follow_up, etc.)';
