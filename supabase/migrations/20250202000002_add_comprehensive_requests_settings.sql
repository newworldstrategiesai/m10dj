-- Add comprehensive requests page settings to organizations table
...
COMMENT ON COLUMN public.organizations.requests_default_request_type IS 'Default request type selected when page loads';
